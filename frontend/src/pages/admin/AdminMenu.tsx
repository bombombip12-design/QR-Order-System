  ...
  return (
    <div className="space-y-6">
      ...
      {(creating || editing) && (
        <div className="card p-4 space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              onClick={() => { setCreating(false); setEditing(null); setName(''); setDescription(''); setPrice(''); setImageUrl(''); }}
            ...
            <div className="flex items-center gap-3 min-w-0 flex-1">
              {m.image ? (
                <img
                  src={m.image}
                  alt={m.name}
                  className="w-14 h-14 rounded-lg object-cover flex-shrink-0 bg-surface-elevated"
                />
              ) : (
              ...
              <div className="min-w-0">
                ...
                <p className="text-brand-400 font-medium">{m.price.toLocaleString('vi-VN')}₫</p>
              </div>
            </div>
            <div className="flex gap-2">
      ...
      {items.length === 0 && !creating && (
        <p className="text-gray-400 text-center py-8">Chưa có món. Nhấn &quot;Thêm món&quot; để tạo.</p>
      )}
      {confirmDeleteId && (
