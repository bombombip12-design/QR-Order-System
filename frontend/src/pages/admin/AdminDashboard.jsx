/** Trang chủ admin: chỉ là các liên kết nhanh tới từng module (logic chi tiết nằm ở từng trang con + adminApi). */
import { Link } from 'react-router-dom'
import { UtensilsCrossed, FolderTree, Coffee, Users, BarChart3, CreditCard, Star } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {links.map(({ to, icon: Icon, label }) => (
          <Link key={to} to={to} className="card p-5 flex items-center gap-4 hover:border-brand-500/50 transition-colors">
